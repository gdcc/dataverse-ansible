...
This is the 5.0 branch, which installs the Dataverse 5.0 release (production warfile). You may edit the dataverse_branch and dataverse.version group_vars if you like.
